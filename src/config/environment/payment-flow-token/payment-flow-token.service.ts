...
@Injectable()
export class PaymentFlowTokenService {
  async onModuleInit() {
    console.log("Let's simulate a Polkadot Pay flow with token in Asset Hub ... \n")
    ...
    const { label, message, amount, tokenID, reference } = await simulateCheckout()
    ...
    console.log(`Block: https://assethub-westend.subscan.io/extrinsic/${blockHash.toHex()}`)
    console.log(`Extrinsic: https://assethub-westend.subscan.io/extrinsic/${extrinsicHash.toHex()}`)
