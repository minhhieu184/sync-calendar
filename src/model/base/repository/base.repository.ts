import { PrismaExtension } from '@model/prisma'
...
{
  constructor(protected readonly model: PrismaExtension[Uncapitalize<M>]) {}
  ...
  >(
    ...
    const findUniqueOrThrowFn = this.model.findUniqueOrThrow<BaseFindUniqueArgs>
    const args = options
      ? Object.assign({ where: { id } }, options)
      : { where: { id } }
